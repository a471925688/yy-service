...
layui.define(['layer'], function (exports) {
    ...
    var admin = {
        ...
        open: function (param) {
            ...
            param.success = function (layero, index) {
                ...
                admin.ajax({
                    ...
                    //     if(admin.token)
                    //         request.setRequestHeader("Authorization", admin.token);
                    //     },
        ...
        req: function (url, data, success, method,showMsg) {
        ...
        ajax: function (param) {
                ...
                if (jsonRs) {
                    if (jsonRs.code == 401) {
                        layer.msg(jsonRs.msg, {icon: 2, time: 1500}, function () {
                            location.replace('/messenger/login');
                        }, 1000);
                        return;
            ...
            param.beforeSend = function(request) {
                if(admin.token)
                    request.setRequestHeader("Authorization", admin.token);
            },
